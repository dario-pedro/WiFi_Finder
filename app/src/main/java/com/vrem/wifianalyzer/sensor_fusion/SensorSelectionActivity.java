...
public class SensorSelectionActivity extends FragmentActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
            case 0:
                return getString(R.string.sf_title_section1).toUpperCase(l);
            case 1:
                return getString(R.string.sf_title_section2).toUpperCase(l);
            case 2:
                return getString(R.string.sf_title_section3).toUpperCase(l);
            case 3:
                return getString(R.string.sf_title_section4).toUpperCase(l);
            case 4:
                return getString(R.string.sf_title_section5).toUpperCase(l);
            case 5:
                return getString(R.string.sf_title_section6).toUpperCase(l);
            }
            return null;
        }
    }
