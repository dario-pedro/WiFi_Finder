...
public class StepLengthPreference extends DialogPreference {
    ...
    public StepLengthPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        setDialogLayoutResource(R.layout.step_length_dialog);
    ...
    protected void onBindDialogView(View view) {
        ...
        numberPicker = (NumberPicker) view.findViewById(R.id.step_length_picker);
